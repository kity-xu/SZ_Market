...
type BlockShotC struct{}

func NewBlockShotC() *BlockShotC {
	return &BlockShotC{}
}

func (this *BlockShotC) POST(c *gin.Context) {
...
func (this *BlockShotC) PostJson(c *gin.Context) {
	var req protocol.RequestBlockShot
	...
	data, err := publish.NewBlockShotM().GetBlockShotM(&req)
	if err != nil {
		logging.Error("%v", err)
...
func (this *BlockShotC) PostPB(c *gin.Context) {
	var req protocol.RequestBlockShot
	...
	WriteDataPB(c, protocol.HAINA_PUBLISH_CMD_ACK_BLOCKSHOT, data)
}
