...
func (this *Fundflow) POST(c *gin.Context) {
...
func (this *Fundflow) PostJson(c *gin.Context) {
	var req protocol.RequestFundflow
	...
	reply, err := publish.NewFundflow(publish.REDISKEY_FUND_FLOW).GetFundflowReply(&req)
	if err != nil {
		logging.Error("%v", err)
...
func (this *Fundflow) PostPB(c *gin.Context) {
	var req protocol.RequestFundflow
	...
	WriteDataPB(c, protocol.HAINA_PUBLISH_CMD_ACK_FUNDFLOW, reply)
}
