...
func (this *Factor) POST(c *gin.Context) {
...
func (this *Factor) PostJson(c *gin.Context) {
	var req protocol.RequestFactor
	...
	payload, err := publish.NewFactor().GetFactorObj(&req)
	if err != nil {
		logging.Error("%v", err)
...
func (this *Factor) PostPB(c *gin.Context) {
	var req protocol.RequestFactor
	...
	WriteDataPB(c, protocol.HAINA_PUBLISH_CMD_ACK_FACTOR, payload)
}
